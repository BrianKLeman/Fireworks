#include "PurpleRocket.h"

CPurpleRocket::CPurpleRocket(vector<CAbstractParticle*>* pManagersLeftOverParticles,const D3DXVECTOR3& pos,const D3DXVECTOR3& vel,const D3DXVECTOR3& acc,const D3DXVECTOR3& thrust_,float energy_,float life_time)
:CRocket(pManagersLeftOverParticles,pos,vel,acc,thrust_,energy_,life_time)
{

}

CPurpleRocket::~CPurpleRocket(void)
{
}

void CPurpleRocket::update()
{
...
vector<CAbstractParticle>* CPurpleRocket::command1() //called on event 1 i.e. explode into more particles
{
