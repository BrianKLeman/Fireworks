#include "GreenRocket.h"

CGreenRocket::CGreenRocket(vector<CAbstractParticle*>* pManagersLeftOverParticles,const D3DXVECTOR3& pos,const D3DXVECTOR3& vel,const D3DXVECTOR3& acc,const D3DXVECTOR3& thrust_,float energy_,float life_time)
:CRocket(pManagersLeftOverParticles,pos,vel,acc,thrust_,energy_,life_time)
{

}

CGreenRocket::~CGreenRocket(void)
{
}

void CGreenRocket::update()
{
...
vector<CAbstractParticle>* CGreenRocket::command1() //called on event 1 i.e. explode into more particles
{
